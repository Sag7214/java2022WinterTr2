...
public class C07_split {
    public static void main(String[] args) {
      ...
      String kelimeler[] =str.split(" "); // bosluktan al denince aralarina virgul  koyar
        //Boylece kelimeleri aliriz    [Java, gun, gectikce, guzellesiyor]
        ...
        String harfler[]= str.split(""); // hiclikten bolersek harfleri aliriz
