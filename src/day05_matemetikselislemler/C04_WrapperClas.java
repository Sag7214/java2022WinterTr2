...
public class C04_WrapperClas {
    public static void main(String[] args) {
        ...
        // prpmitive  data turu ile nan - prpmitive arasindaki farklar nelerdir?
        ...
        // nan  - primitive data turleri data depolalmak disinda bircok faydali metoda sahiptir
        // ancak primitive data turleri sadece degerleri saklarlar
