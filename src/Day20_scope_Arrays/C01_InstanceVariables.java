...
public class C01_InstanceVariables {
    ...
    public static void main(String[] args) {
        ...
        obje1.bransIsmi="SQL";
        System.out.println(obje1.okuldaMi); //deger atanmadgi icin class degerden boolen
                                                // icin defauld degeri olan false verir
        ...
        obje1.okuldaMi=true;
        System.out.println(obj2.okuldaMi);  // obj2 ' ye yine deger atamasi yok yine false verir (default degeri)
    }
}
