...
public class Lambda02 {
    ...
    public static void main(String[] args) {
        ...
        ciftCarp(sayi);
          ...
          // Task : Functional Programming ile listin cift elemanlarinin  karelerini ayni satirda
    ...
    public static void ciftKarePrint(List<Integer> sayi) {
        sayi.
                ...
                forEach(Lambda01::yazdir);         // veya üzerlerinde işlem yapmak (update) için Map kullanılmaktadır.
    ...
    public static void tekKupBirFazlaPrint(List<Integer> sayi) {
        ...
        sayi.
                stream().
                filter(Lambda01::ciftBul).
                map(Math::sqrt).//meth ref--> double deger return eder. karekok alininca dooble deger return ettigi icin
                //Lambda01::yazdir methodu int calistigi icn bunu kullanmadik .
                // ( matematik clasindan Math.sgrt karekok alma secilir)
    ...
    public static void elTopla(List<Integer> sayi){
        ...
        //Method Ref...
        Optional<Integer> topla=  sayi.stream().reduce(Integer::sum); // yukarida int yazdik hata vermedi 0 degeri
        // biz atadigimiz icin burda ilk degeri atamadigimiz icin null donebilecgi icin optional yapmak zorundayiz
    ...
    // Task : List'teki cift elemanlarin carpimini  yazdiriniz.
         ...
         public static void ciftCarp(List<Integer> sayi){
          ...
          //Method Ref... methodla yapma
        System.out.println("method ref :"+sayi.
                stream().
                filter(Lambda01::ciftBul).
                reduce(Math::multiplyExact));

          //Lambda Expression... kendimiz yapma
        System.out.println("Lambda exp. : " +sayi.
                stream().
                filter(Lambda01::ciftBul).
                reduce(1, (a, b) -> (a * b)));  // carpma oldugu icin ilk deger 1 olmali etkisiz eleman
                                                            // yani 0 olursa yutan eleman olur onun icin olma
    }
}
